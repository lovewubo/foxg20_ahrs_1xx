...
MODEL                   = EKF
MODULES                 = EKF_data.c rtGetInf.c rtGetNaN.c rt_backsubrr_dbl.c rt_forwardsubrr_dbl.c rt_lu_real.c rt_matdivrr_dbl.c rt_matrixlib_dbl.c rt_nonfinite.c 
MAKEFILE                = EKF.mk
...
MASTER_ANCHOR_DIR       = 
START_DIR               = C:\Users\Fede\Desktop\dimunuzioneutilizzocpu\FedericoLolli-foxg20_ahrs_1xx-f5acbbd\matlab\matlab-EKF\EKF\ekf-q-corr
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
...
GEN_SAMPLE_MAIN         = 1
TARGET_LANG_EXT         = c
MEX_OPT_FILE            = -f C:\Users\Fede\AppData\Roaming\MATHWO~1\MATLAB\R2011a\mexopts.bat
COMPUTER                = PCWIN64
...
MODELLIB                  = EKFlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = EKF_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\EKF_ert_rtw
