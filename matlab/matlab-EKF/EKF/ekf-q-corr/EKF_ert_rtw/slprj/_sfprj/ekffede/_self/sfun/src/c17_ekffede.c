...
static void c17_chartstep_c17_ekffede(SFc17_ekffedeInstanceStruct *chartInstance);
...
static const mxArray *c17_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static void c17_emlrt_marshallIn(SFc17_ekffedeInstanceStruct *chartInstance,
  const mxArray *c17_quat_dot, const char_T *c17_identifier, real_T c17_y[4]);
static void c17_b_emlrt_marshallIn(SFc17_ekffedeInstanceStruct *chartInstance,
...
static const mxArray *c17_c_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static real_T c17_c_emlrt_marshallIn(SFc17_ekffedeInstanceStruct *chartInstance,
...
static const mxArray *c17_d_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static void c17_d_emlrt_marshallIn(SFc17_ekffedeInstanceStruct *chartInstance,
...
static void c17_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c17_mxArrayInData, const char_T *c17_varName, void *c17_outData);
static void c17_eml_scalar_eg(SFc17_ekffedeInstanceStruct *chartInstance);
static const mxArray *c17_e_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static int32_T c17_e_emlrt_marshallIn(SFc17_ekffedeInstanceStruct *chartInstance,
  const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void c17_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c17_mxArrayInData, const char_T *c17_varName, void *c17_outData);
static uint8_T c17_f_emlrt_marshallIn(SFc17_ekffedeInstanceStruct *chartInstance,
  const mxArray *c17_b_is_active_c17_ekffede, const char_T *c17_identifier);
static uint8_T c17_g_emlrt_marshallIn(SFc17_ekffedeInstanceStruct *chartInstance,
  const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
  ...
  *chartInstance)
{
  ...
  c17_hoistedGlobal = chartInstance->c17_is_active_c17_ekffede;
  ...
  const mxArray *c17_st)
{
  ...
  chartInstance->c17_is_active_c17_ekffede = c17_f_emlrt_marshallIn
...
static void sf_c17_ekffede(SFc17_ekffedeInstanceStruct *chartInstance)
{
  ...
  chartInstance->c17_sfEvent = CALL_EVENT;
  c17_chartstep_c17_ekffede(chartInstance);
...
static const mxArray *sf_get_sim_state_info_c17_ekffede(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"quat_dot\",},{M[8],M[0],T\"is_active_c17_ekffede\",}}"
  };
...
static void mdlSetWorkWidths_c17_ekffede(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"ekffede","ekffede",17,2);
