...
static void initialize_c15_EKF(SFc15_EKFInstanceStruct *chartInstance);
static void initialize_params_c15_EKF(SFc15_EKFInstanceStruct *chartInstance);
static void enable_c15_EKF(SFc15_EKFInstanceStruct *chartInstance);
static void disable_c15_EKF(SFc15_EKFInstanceStruct *chartInstance);
static void c15_update_debugger_state_c15_EKF(SFc15_EKFInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c15_EKF(SFc15_EKFInstanceStruct
  *chartInstance);
static void set_sim_state_c15_EKF(SFc15_EKFInstanceStruct *chartInstance, const
  mxArray *c15_st);
static void finalize_c15_EKF(SFc15_EKFInstanceStruct *chartInstance);
static void sf_c15_EKF(SFc15_EKFInstanceStruct *chartInstance);
static void c15_chartstep_c15_EKF(SFc15_EKFInstanceStruct *chartInstance);
static void initSimStructsc15_EKF(SFc15_EKFInstanceStruct *chartInstance);
...
static const mxArray *c15_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static void c15_emlrt_marshallIn(SFc15_EKFInstanceStruct *chartInstance, const
  mxArray *c15_mag_calibrate, const char_T *c15_identifier, real_T c15_y[3]);
static void c15_b_emlrt_marshallIn(SFc15_EKFInstanceStruct *chartInstance, const
...
static const mxArray *c15_c_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static real_T c15_c_emlrt_marshallIn(SFc15_EKFInstanceStruct *chartInstance,
...
static const mxArray *c15_d_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static void c15_d_emlrt_marshallIn(SFc15_EKFInstanceStruct *chartInstance, const
...
static void c15_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c15_mxArrayInData, const char_T *c15_varName, void *c15_outData);
static void c15_eml_scalar_eg(SFc15_EKFInstanceStruct *chartInstance);
static const mxArray *c15_e_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static int32_T c15_e_emlrt_marshallIn(SFc15_EKFInstanceStruct *chartInstance,
  const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void c15_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c15_mxArrayInData, const char_T *c15_varName, void *c15_outData);
static uint8_T c15_f_emlrt_marshallIn(SFc15_EKFInstanceStruct *chartInstance,
  const mxArray *c15_b_is_active_c15_EKF, const char_T *c15_identifier);
static uint8_T c15_g_emlrt_marshallIn(SFc15_EKFInstanceStruct *chartInstance,
  const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void init_dsm_address_info(SFc15_EKFInstanceStruct *chartInstance);
...
static void initialize_c15_EKF(SFc15_EKFInstanceStruct *chartInstance)
{
  ...
  chartInstance->c15_is_active_c15_EKF = 0U;
}
  ...
  *chartInstance)
{
  ...
  c15_hoistedGlobal = chartInstance->c15_is_active_c15_EKF;
  ...
  mxArray *c15_st)
{
  ...
  chartInstance->c15_is_active_c15_EKF = c15_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c15_u, 1)), "is_active_c15_EKF");
  sf_mex_destroy(&c15_u);
  c15_update_debugger_state_c15_EKF(chartInstance);
...
static void sf_c15_EKF(SFc15_EKFInstanceStruct *chartInstance)
{
  ...
  chartInstance->c15_sfEvent = CALL_EVENT;
  c15_chartstep_c15_EKF(chartInstance);
  ...
  *c15_inData)
{
  ...
  real_T c15_u[3];
  const mxArray *c15_y = NULL;
  SFc15_EKFInstanceStruct *chartInstance;
  chartInstance = (SFc15_EKFInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c15_EKF_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c15_b_is_active_c15_EKF, const char_T *c15_identifier)
{
  ...
  c15_y = c15_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c15_b_is_active_c15_EKF), &c15_thisId);
  sf_mex_destroy(&c15_b_is_active_c15_EKF);
  return c15_y;
}
...
/* SFunction Glue Code */
void sf_c15_EKF_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c15_EKF_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c15_EKF(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"mag_calibrate\",},{M[8],M[0],T\"is_active_c15_EKF\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c15_EKF_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc15_EKFInstanceStruct *chartInstance;
    chartInstance = (SFc15_EKFInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c15_EKF(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc15_EKFInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c15_EKF((SFc15_EKFInstanceStruct*) chartInstanceVar);
  initialize_c15_EKF((SFc15_EKFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c15_EKF(void *chartInstanceVar)
{
  enable_c15_EKF((SFc15_EKFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c15_EKF(void *chartInstanceVar)
{
  disable_c15_EKF((SFc15_EKFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c15_EKF(void *chartInstanceVar)
{
  sf_c15_EKF((SFc15_EKFInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c15_EKF(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c15_EKF((SFc15_EKFInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c15_EKF();/* state var info */
...
extern void sf_internal_set_sim_state_c15_EKF(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c15_EKF((SFc15_EKFInstanceStruct*)chartInfo->chartInstance,
                        mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c15_EKF(SimStruct* S)
{
  return sf_internal_get_sim_state_c15_EKF(S);
}

static void sf_opaque_set_sim_state_c15_EKF(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c15_EKF(S, st);
}

static void sf_opaque_terminate_c15_EKF(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc15_EKFInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c15_EKF((SFc15_EKFInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc15_EKF((SFc15_EKFInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c15_EKF(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c15_EKF((SFc15_EKFInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c15_EKF(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"EKF","EKF",15);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"EKF","EKF",15,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"EKF","EKF",15,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"EKF","EKF",15,2);
      sf_mark_chart_reusable_outputs(S,"EKF","EKF",15,1);
    }

    sf_set_rtw_dwork_info(S,"EKF","EKF",15);
...
static void mdlRTW_c15_EKF(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "EKF", "EKF",15);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c15_EKF(SimStruct *S)
{
  SFc15_EKFInstanceStruct *chartInstance;
  chartInstance = (SFc15_EKFInstanceStruct *)malloc(sizeof
    (SFc15_EKFInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc15_EKFInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c15_EKF;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c15_EKF;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c15_EKF;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c15_EKF;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c15_EKF;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c15_EKF;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c15_EKF;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c15_EKF;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c15_EKF;
  chartInstance->chartInfo.mdlStart = mdlStart_c15_EKF;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c15_EKF;
...
void c15_EKF_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c15_EKF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c15_EKF(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c15_EKF_method_dispatcher.\n"
