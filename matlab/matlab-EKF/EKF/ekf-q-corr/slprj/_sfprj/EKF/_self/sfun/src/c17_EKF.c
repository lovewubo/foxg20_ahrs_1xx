...
static const mxArray *c17_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static real_T c17_emlrt_marshallIn(SFc17_EKFInstanceStruct *chartInstance, const
  mxArray *c17_y, const char_T *c17_identifier);
static real_T c17_b_emlrt_marshallIn(SFc17_EKFInstanceStruct *chartInstance,
...
static const mxArray *c17_b_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static int32_T c17_c_emlrt_marshallIn(SFc17_EKFInstanceStruct *chartInstance,
  const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void c17_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c17_mxArrayInData, const char_T *c17_varName, void *c17_outData);
static uint8_T c17_d_emlrt_marshallIn(SFc17_EKFInstanceStruct *chartInstance,
  const mxArray *c17_b_is_active_c17_EKF, const char_T *c17_identifier);
static uint8_T c17_e_emlrt_marshallIn(SFc17_EKFInstanceStruct *chartInstance,
  const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
  ...
  *chartInstance)
{
  ...
  c17_b_hoistedGlobal = chartInstance->c17_is_active_c17_EKF;
  ...
  mxArray *c17_st)
{
  ...
  *c17_y = c17_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c17_u,
    0)), "y");
  chartInstance->c17_is_active_c17_EKF = c17_d_emlrt_marshallIn(chartInstance,
...
static const mxArray *sf_get_sim_state_info_c17_EKF(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c17_EKF\",}}"
  };
...
static void mdlSetWorkWidths_c17_EKF(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"EKF","EKF",17,1);
