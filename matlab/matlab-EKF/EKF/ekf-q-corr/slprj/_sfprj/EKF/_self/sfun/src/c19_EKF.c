...
static void c19_chartstep_c19_EKF(SFc19_EKFInstanceStruct *chartInstance);
...
static const mxArray *c19_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static void c19_emlrt_marshallIn(SFc19_EKFInstanceStruct *chartInstance, const
  mxArray *c19_quat_dot, const char_T *c19_identifier, real_T c19_y[4]);
static void c19_b_emlrt_marshallIn(SFc19_EKFInstanceStruct *chartInstance, const
...
static const mxArray *c19_c_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static real_T c19_c_emlrt_marshallIn(SFc19_EKFInstanceStruct *chartInstance,
...
static const mxArray *c19_d_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static void c19_d_emlrt_marshallIn(SFc19_EKFInstanceStruct *chartInstance, const
...
static void c19_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c19_mxArrayInData, const char_T *c19_varName, void *c19_outData);
static void c19_eml_scalar_eg(SFc19_EKFInstanceStruct *chartInstance);
static const mxArray *c19_e_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static int32_T c19_e_emlrt_marshallIn(SFc19_EKFInstanceStruct *chartInstance,
  const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void c19_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c19_mxArrayInData, const char_T *c19_varName, void *c19_outData);
static uint8_T c19_f_emlrt_marshallIn(SFc19_EKFInstanceStruct *chartInstance,
  const mxArray *c19_b_is_active_c19_EKF, const char_T *c19_identifier);
static uint8_T c19_g_emlrt_marshallIn(SFc19_EKFInstanceStruct *chartInstance,
  const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
  ...
  *chartInstance)
{
  ...
  c19_hoistedGlobal = chartInstance->c19_is_active_c19_EKF;
  ...
  mxArray *c19_st)
{
  ...
  chartInstance->c19_is_active_c19_EKF = c19_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c19_u, 1)), "is_active_c19_EKF");
...
static void sf_c19_EKF(SFc19_EKFInstanceStruct *chartInstance)
{
  ...
  chartInstance->c19_sfEvent = CALL_EVENT;
  c19_chartstep_c19_EKF(chartInstance);
...
static const mxArray *sf_get_sim_state_info_c19_EKF(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"quat_dot\",},{M[8],M[0],T\"is_active_c19_EKF\",}}"
  };
...
static void mdlSetWorkWidths_c19_EKF(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_reusable_outputs(S,"EKF","EKF",19,1);
    }
