...
static const mxArray *c19_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static real_T c19_emlrt_marshallIn(SFc19_ekffedeInstanceStruct *chartInstance,
  const mxArray *c19_prev_out, const char_T *c19_identifier);
static real_T c19_b_emlrt_marshallIn(SFc19_ekffedeInstanceStruct *chartInstance,
...
static const mxArray *c19_b_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static int32_T c19_c_emlrt_marshallIn(SFc19_ekffedeInstanceStruct *chartInstance,
  const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void c19_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c19_mxArrayInData, const char_T *c19_varName, void *c19_outData);
static uint8_T c19_d_emlrt_marshallIn(SFc19_ekffedeInstanceStruct *chartInstance,
  const mxArray *c19_b_is_active_c19_ekffede, const char_T *c19_identifier);
static uint8_T c19_e_emlrt_marshallIn(SFc19_ekffedeInstanceStruct *chartInstance,
  const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
  ...
  *chartInstance)
{
  ...
  c19_c_hoistedGlobal = chartInstance->c19_is_active_c19_ekffede;
  ...
  const mxArray *c19_st)
{
  ...
  *c19_y = c19_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c19_u,
    1)), "y");
  chartInstance->c19_is_active_c19_ekffede = c19_d_emlrt_marshallIn
...
static const mxArray *sf_get_sim_state_info_c19_ekffede(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[7],T\"prev_out\",},{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c19_ekffede\",}}"
  };
...
static void mdlSetWorkWidths_c19_ekffede(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_reusable_outputs(S,"ekffede","ekffede",19,2);
    }
