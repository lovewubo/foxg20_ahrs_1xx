...
static void initialize_c19_ekffede(SFc19_ekffedeInstanceStruct *chartInstance);
static void initialize_params_c19_ekffede(SFc19_ekffedeInstanceStruct
  *chartInstance);
static void enable_c19_ekffede(SFc19_ekffedeInstanceStruct *chartInstance);
static void disable_c19_ekffede(SFc19_ekffedeInstanceStruct *chartInstance);
static void c19_update_debugger_state_c19_ekffede(SFc19_ekffedeInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c19_ekffede(SFc19_ekffedeInstanceStruct
  *chartInstance);
static void set_sim_state_c19_ekffede(SFc19_ekffedeInstanceStruct *chartInstance,
  const mxArray *c19_st);
static void finalize_c19_ekffede(SFc19_ekffedeInstanceStruct *chartInstance);
static void sf_c19_ekffede(SFc19_ekffedeInstanceStruct *chartInstance);
static void c19_chartstep_c19_ekffede(SFc19_ekffedeInstanceStruct *chartInstance);
static void initSimStructsc19_ekffede(SFc19_ekffedeInstanceStruct *chartInstance);
...
static const mxArray *c19_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static void c19_emlrt_marshallIn(SFc19_ekffedeInstanceStruct *chartInstance,
  const mxArray *c19_quat_dot, const char_T *c19_identifier, real_T c19_y[4]);
static void c19_b_emlrt_marshallIn(SFc19_ekffedeInstanceStruct *chartInstance,
...
static const mxArray *c19_c_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static real_T c19_c_emlrt_marshallIn(SFc19_ekffedeInstanceStruct *chartInstance,
...
static const mxArray *c19_d_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static void c19_d_emlrt_marshallIn(SFc19_ekffedeInstanceStruct *chartInstance,
...
static void c19_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c19_mxArrayInData, const char_T *c19_varName, void *c19_outData);
static void c19_eml_scalar_eg(SFc19_ekffedeInstanceStruct *chartInstance);
static const mxArray *c19_e_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static int32_T c19_e_emlrt_marshallIn(SFc19_ekffedeInstanceStruct *chartInstance,
  const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void c19_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c19_mxArrayInData, const char_T *c19_varName, void *c19_outData);
static uint8_T c19_f_emlrt_marshallIn(SFc19_ekffedeInstanceStruct *chartInstance,
  const mxArray *c19_b_is_active_c19_ekffede, const char_T *c19_identifier);
static uint8_T c19_g_emlrt_marshallIn(SFc19_ekffedeInstanceStruct *chartInstance,
  const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void init_dsm_address_info(SFc19_ekffedeInstanceStruct *chartInstance);
...
static void initialize_c19_ekffede(SFc19_ekffedeInstanceStruct *chartInstance)
{
  ...
  chartInstance->c19_is_active_c19_ekffede = 0U;
}
  ...
  *chartInstance)
{
  ...
  c19_hoistedGlobal = chartInstance->c19_is_active_c19_ekffede;
  ...
  const mxArray *c19_st)
{
  ...
  chartInstance->c19_is_active_c19_ekffede = c19_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c19_u, 1)),
     "is_active_c19_ekffede");
  sf_mex_destroy(&c19_u);
  c19_update_debugger_state_c19_ekffede(chartInstance);
...
static void sf_c19_ekffede(SFc19_ekffedeInstanceStruct *chartInstance)
{
  ...
  chartInstance->c19_sfEvent = CALL_EVENT;
  c19_chartstep_c19_ekffede(chartInstance);
  ...
  *c19_inData)
{
  ...
  real_T c19_u[4];
  const mxArray *c19_y = NULL;
  SFc19_ekffedeInstanceStruct *chartInstance;
  chartInstance = (SFc19_ekffedeInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c19_ekffede_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c19_b_is_active_c19_ekffede, const char_T *c19_identifier)
{
  ...
  c19_y = c19_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c19_b_is_active_c19_ekffede), &c19_thisId);
  sf_mex_destroy(&c19_b_is_active_c19_ekffede);
  return c19_y;
}
...
/* SFunction Glue Code */
void sf_c19_ekffede_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c19_ekffede_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c19_ekffede(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"quat_dot\",},{M[8],M[0],T\"is_active_c19_ekffede\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c19_ekffede_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc19_ekffedeInstanceStruct *chartInstance;
    chartInstance = (SFc19_ekffedeInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c19_ekffede(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc19_ekffedeInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c19_ekffede((SFc19_ekffedeInstanceStruct*) chartInstanceVar);
  initialize_c19_ekffede((SFc19_ekffedeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c19_ekffede(void *chartInstanceVar)
{
  enable_c19_ekffede((SFc19_ekffedeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c19_ekffede(void *chartInstanceVar)
{
  disable_c19_ekffede((SFc19_ekffedeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c19_ekffede(void *chartInstanceVar)
{
  sf_c19_ekffede((SFc19_ekffedeInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c19_ekffede(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c19_ekffede((SFc19_ekffedeInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c19_ekffede();/* state var info */
...
extern void sf_internal_set_sim_state_c19_ekffede(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c19_ekffede((SFc19_ekffedeInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c19_ekffede(SimStruct* S)
{
  return sf_internal_get_sim_state_c19_ekffede(S);
}

static void sf_opaque_set_sim_state_c19_ekffede(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c19_ekffede(S, st);
}

static void sf_opaque_terminate_c19_ekffede(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc19_ekffedeInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c19_ekffede((SFc19_ekffedeInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc19_ekffede((SFc19_ekffedeInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c19_ekffede(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c19_ekffede((SFc19_ekffedeInstanceStruct*)
      (((ChartInfoStruct *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c19_ekffede(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"ekffede","ekffede",19);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"ekffede","ekffede",19,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"ekffede","ekffede",19,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"ekffede","ekffede",19,2);
      sf_mark_chart_reusable_outputs(S,"ekffede","ekffede",19,1);
    }

    sf_set_rtw_dwork_info(S,"ekffede","ekffede",19);
...
static void mdlRTW_c19_ekffede(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "ekffede", "ekffede",19);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c19_ekffede(SimStruct *S)
{
  SFc19_ekffedeInstanceStruct *chartInstance;
  chartInstance = (SFc19_ekffedeInstanceStruct *)malloc(sizeof
    (SFc19_ekffedeInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc19_ekffedeInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c19_ekffede;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c19_ekffede;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c19_ekffede;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c19_ekffede;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c19_ekffede;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c19_ekffede;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c19_ekffede;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c19_ekffede;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c19_ekffede;
  chartInstance->chartInfo.mdlStart = mdlStart_c19_ekffede;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c19_ekffede;
...
void c19_ekffede_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c19_ekffede(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c19_ekffede(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c19_ekffede(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c19_ekffede_method_dispatcher.\n"
