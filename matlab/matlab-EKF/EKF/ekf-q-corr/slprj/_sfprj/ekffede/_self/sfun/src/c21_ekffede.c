...
static void initialize_c21_ekffede(SFc21_ekffedeInstanceStruct *chartInstance);
static void initialize_params_c21_ekffede(SFc21_ekffedeInstanceStruct
  *chartInstance);
static void enable_c21_ekffede(SFc21_ekffedeInstanceStruct *chartInstance);
static void disable_c21_ekffede(SFc21_ekffedeInstanceStruct *chartInstance);
static void c21_update_debugger_state_c21_ekffede(SFc21_ekffedeInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c21_ekffede(SFc21_ekffedeInstanceStruct
  *chartInstance);
static void set_sim_state_c21_ekffede(SFc21_ekffedeInstanceStruct *chartInstance,
  const mxArray *c21_st);
static void finalize_c21_ekffede(SFc21_ekffedeInstanceStruct *chartInstance);
static void sf_c21_ekffede(SFc21_ekffedeInstanceStruct *chartInstance);
static void initSimStructsc21_ekffede(SFc21_ekffedeInstanceStruct *chartInstance);
...
static const mxArray *c21_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static real_T c21_emlrt_marshallIn(SFc21_ekffedeInstanceStruct *chartInstance,
  const mxArray *c21_yaw_dot, const char_T *c21_identifier);
static real_T c21_b_emlrt_marshallIn(SFc21_ekffedeInstanceStruct *chartInstance,
...
static const mxArray *c21_c_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static int32_T c21_c_emlrt_marshallIn(SFc21_ekffedeInstanceStruct *chartInstance,
  const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static void c21_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c21_mxArrayInData, const char_T *c21_varName, void *c21_outData);
static uint8_T c21_d_emlrt_marshallIn(SFc21_ekffedeInstanceStruct *chartInstance,
  const mxArray *c21_b_is_active_c21_ekffede, const char_T *c21_identifier);
static uint8_T c21_e_emlrt_marshallIn(SFc21_ekffedeInstanceStruct *chartInstance,
  const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static void init_dsm_address_info(SFc21_ekffedeInstanceStruct *chartInstance);
...
static void initialize_c21_ekffede(SFc21_ekffedeInstanceStruct *chartInstance)
{
  ...
  chartInstance->c21_is_active_c21_ekffede = 0U;
}
  ...
  *chartInstance)
{
  ...
  c21_b_hoistedGlobal = chartInstance->c21_is_active_c21_ekffede;
  ...
  const mxArray *c21_st)
{
  ...
  *c21_yaw_dot = c21_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c21_u, 0)), "yaw_dot");
  chartInstance->c21_is_active_c21_ekffede = c21_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c21_u, 1)),
     "is_active_c21_ekffede");
  sf_mex_destroy(&c21_u);
  c21_update_debugger_state_c21_ekffede(chartInstance);
  ...
  *c21_inData)
{
  ...
  real_T c21_u;
  const mxArray *c21_y = NULL;
  SFc21_ekffedeInstanceStruct *chartInstance;
  chartInstance = (SFc21_ekffedeInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c21_ekffede_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c21_b_is_active_c21_ekffede, const char_T *c21_identifier)
{
  ...
  c21_y = c21_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c21_b_is_active_c21_ekffede), &c21_thisId);
  sf_mex_destroy(&c21_b_is_active_c21_ekffede);
  return c21_y;
}
...
/* SFunction Glue Code */
void sf_c21_ekffede_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c21_ekffede_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c21_ekffede(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"yaw_dot\",},{M[8],M[0],T\"is_active_c21_ekffede\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c21_ekffede_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc21_ekffedeInstanceStruct *chartInstance;
    chartInstance = (SFc21_ekffedeInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c21_ekffede(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc21_ekffedeInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c21_ekffede((SFc21_ekffedeInstanceStruct*) chartInstanceVar);
  initialize_c21_ekffede((SFc21_ekffedeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c21_ekffede(void *chartInstanceVar)
{
  enable_c21_ekffede((SFc21_ekffedeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c21_ekffede(void *chartInstanceVar)
{
  disable_c21_ekffede((SFc21_ekffedeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c21_ekffede(void *chartInstanceVar)
{
  sf_c21_ekffede((SFc21_ekffedeInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c21_ekffede(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c21_ekffede((SFc21_ekffedeInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c21_ekffede();/* state var info */
...
extern void sf_internal_set_sim_state_c21_ekffede(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c21_ekffede((SFc21_ekffedeInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c21_ekffede(SimStruct* S)
{
  return sf_internal_get_sim_state_c21_ekffede(S);
}

static void sf_opaque_set_sim_state_c21_ekffede(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c21_ekffede(S, st);
}

static void sf_opaque_terminate_c21_ekffede(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc21_ekffedeInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c21_ekffede((SFc21_ekffedeInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc21_ekffede((SFc21_ekffedeInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c21_ekffede(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c21_ekffede((SFc21_ekffedeInstanceStruct*)
      (((ChartInfoStruct *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c21_ekffede(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"ekffede","ekffede",21);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"ekffede","ekffede",21,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"ekffede","ekffede",21,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"ekffede","ekffede",21,3);
      sf_mark_chart_reusable_outputs(S,"ekffede","ekffede",21,1);
    }

    sf_set_rtw_dwork_info(S,"ekffede","ekffede",21);
...
static void mdlRTW_c21_ekffede(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "ekffede", "ekffede",21);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c21_ekffede(SimStruct *S)
{
  SFc21_ekffedeInstanceStruct *chartInstance;
  chartInstance = (SFc21_ekffedeInstanceStruct *)malloc(sizeof
    (SFc21_ekffedeInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc21_ekffedeInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c21_ekffede;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c21_ekffede;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c21_ekffede;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c21_ekffede;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c21_ekffede;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c21_ekffede;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c21_ekffede;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c21_ekffede;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c21_ekffede;
  chartInstance->chartInfo.mdlStart = mdlStart_c21_ekffede;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c21_ekffede;
...
void c21_ekffede_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c21_ekffede(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c21_ekffede(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c21_ekffede(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c21_ekffede_method_dispatcher.\n"
