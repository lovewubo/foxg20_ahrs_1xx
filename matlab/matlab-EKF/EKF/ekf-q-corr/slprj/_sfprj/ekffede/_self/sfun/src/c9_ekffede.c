...
static void initialize_c9_ekffede(SFc9_ekffedeInstanceStruct *chartInstance);
static void initialize_params_c9_ekffede(SFc9_ekffedeInstanceStruct
  *chartInstance);
static void enable_c9_ekffede(SFc9_ekffedeInstanceStruct *chartInstance);
static void disable_c9_ekffede(SFc9_ekffedeInstanceStruct *chartInstance);
static void c9_update_debugger_state_c9_ekffede(SFc9_ekffedeInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c9_ekffede(SFc9_ekffedeInstanceStruct
  *chartInstance);
static void set_sim_state_c9_ekffede(SFc9_ekffedeInstanceStruct *chartInstance,
  const mxArray *c9_st);
static void finalize_c9_ekffede(SFc9_ekffedeInstanceStruct *chartInstance);
static void sf_c9_ekffede(SFc9_ekffedeInstanceStruct *chartInstance);
static void initSimStructsc9_ekffede(SFc9_ekffedeInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c9_machineNumber, uint32_T
  c9_chartNumber);
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData);
static real_T c9_emlrt_marshallIn(SFc9_ekffedeInstanceStruct *chartInstance,
  const mxArray *c9_wave, const char_T *c9_identifier);
static real_T c9_b_emlrt_marshallIn(SFc9_ekffedeInstanceStruct *chartInstance,
  const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static const mxArray *c9_b_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static int32_T c9_c_emlrt_marshallIn(SFc9_ekffedeInstanceStruct *chartInstance,
  const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static uint8_T c9_d_emlrt_marshallIn(SFc9_ekffedeInstanceStruct *chartInstance,
  const mxArray *c9_b_is_active_c9_ekffede, const char_T *c9_identifier);
static uint8_T c9_e_emlrt_marshallIn(SFc9_ekffedeInstanceStruct *chartInstance,
  const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void init_dsm_address_info(SFc9_ekffedeInstanceStruct *chartInstance);
...
static void initialize_c9_ekffede(SFc9_ekffedeInstanceStruct *chartInstance)
{
  ...
  chartInstance->c9_is_active_c9_ekffede = 0U;
}
  ...
  *chartInstance)
{
  ...
  c9_b_hoistedGlobal = chartInstance->c9_is_active_c9_ekffede;
  ...
  const mxArray *c9_st)
{
  ...
  *c9_wave = c9_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c9_u,
    0)), "wave");
  chartInstance->c9_is_active_c9_ekffede = c9_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c9_u, 1)), "is_active_c9_ekffede");
  sf_mex_destroy(&c9_u);
  c9_update_debugger_state_c9_ekffede(chartInstance);
...
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData)
{
  ...
  real_T c9_u;
  const mxArray *c9_y = NULL;
  SFc9_ekffedeInstanceStruct *chartInstance;
  chartInstance = (SFc9_ekffedeInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c9_ekffede_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c9_b_is_active_c9_ekffede, const char_T *c9_identifier)
{
  ...
  c9_y = c9_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c9_b_is_active_c9_ekffede), &c9_thisId);
  sf_mex_destroy(&c9_b_is_active_c9_ekffede);
  return c9_y;
}
...
/* SFunction Glue Code */
void sf_c9_ekffede_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c9_ekffede_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c9_ekffede(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"wave\",},{M[8],M[0],T\"is_active_c9_ekffede\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c9_ekffede_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc9_ekffedeInstanceStruct *chartInstance;
    chartInstance = (SFc9_ekffedeInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c9_ekffede(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc9_ekffedeInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c9_ekffede((SFc9_ekffedeInstanceStruct*) chartInstanceVar);
  initialize_c9_ekffede((SFc9_ekffedeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c9_ekffede(void *chartInstanceVar)
{
  enable_c9_ekffede((SFc9_ekffedeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c9_ekffede(void *chartInstanceVar)
{
  disable_c9_ekffede((SFc9_ekffedeInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c9_ekffede(void *chartInstanceVar)
{
  sf_c9_ekffede((SFc9_ekffedeInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c9_ekffede(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c9_ekffede((SFc9_ekffedeInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c9_ekffede();/* state var info */
...
extern void sf_internal_set_sim_state_c9_ekffede(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c9_ekffede((SFc9_ekffedeInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c9_ekffede(SimStruct* S)
{
  return sf_internal_get_sim_state_c9_ekffede(S);
}

static void sf_opaque_set_sim_state_c9_ekffede(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c9_ekffede(S, st);
}

static void sf_opaque_terminate_c9_ekffede(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc9_ekffedeInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c9_ekffede((SFc9_ekffedeInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc9_ekffede((SFc9_ekffedeInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_ekffede(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c9_ekffede((SFc9_ekffedeInstanceStruct*)(((ChartInfoStruct
      *)ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c9_ekffede(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"ekffede","ekffede",9);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"ekffede","ekffede",9,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"ekffede","ekffede",9,
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"ekffede","ekffede",9,5);
      sf_mark_chart_reusable_outputs(S,"ekffede","ekffede",9,1);
    }

    sf_set_rtw_dwork_info(S,"ekffede","ekffede",9);
...
static void mdlRTW_c9_ekffede(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "ekffede", "ekffede",9);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c9_ekffede(SimStruct *S)
{
  SFc9_ekffedeInstanceStruct *chartInstance;
  chartInstance = (SFc9_ekffedeInstanceStruct *)malloc(sizeof
    (SFc9_ekffedeInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc9_ekffedeInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c9_ekffede;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c9_ekffede;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c9_ekffede;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c9_ekffede;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c9_ekffede;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c9_ekffede;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c9_ekffede;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c9_ekffede;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c9_ekffede;
  chartInstance->chartInfo.mdlStart = mdlStart_c9_ekffede;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c9_ekffede;
...
void c9_ekffede_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c9_ekffede(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_ekffede(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_ekffede(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_ekffede_method_dispatcher.\n"
