...
static void initialize_c12_ekffedepre(SFc12_ekffedepreInstanceStruct
  *chartInstance);
static void initialize_params_c12_ekffedepre(SFc12_ekffedepreInstanceStruct
  *chartInstance);
static void enable_c12_ekffedepre(SFc12_ekffedepreInstanceStruct *chartInstance);
static void disable_c12_ekffedepre(SFc12_ekffedepreInstanceStruct *chartInstance);
static void c12_update_debugger_state_c12_ekffedepre
...
static void finalize_c12_ekffedepre(SFc12_ekffedepreInstanceStruct
  *chartInstance);
static void sf_c12_ekffedepre(SFc12_ekffedepreInstanceStruct *chartInstance);
static void initSimStructsc12_ekffedepre(SFc12_ekffedepreInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber);
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static void c12_emlrt_marshallIn(SFc12_ekffedepreInstanceStruct *chartInstance,
  const mxArray *c12_y, const char_T *c12_identifier, real_T c12_b_y[9]);
static void c12_b_emlrt_marshallIn(SFc12_ekffedepreInstanceStruct *chartInstance,
...
static const mxArray *c12_c_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static real_T c12_c_emlrt_marshallIn(SFc12_ekffedepreInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static const mxArray *c12_d_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int32_T c12_d_emlrt_marshallIn(SFc12_ekffedepreInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static uint8_T c12_e_emlrt_marshallIn(SFc12_ekffedepreInstanceStruct
  *chartInstance, const mxArray *c12_b_is_active_c12_ekffedepre, const char_T
  *c12_identifier);
static uint8_T c12_f_emlrt_marshallIn(SFc12_ekffedepreInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void init_dsm_address_info(SFc12_ekffedepreInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_ekffedepre = 0U;
}
  ...
  *c12_inData)
{
  ...
  const mxArray *c12_y = NULL;
  SFc12_ekffedepreInstanceStruct *chartInstance;
  chartInstance = (SFc12_ekffedepreInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c12_ekffedepre_get_eml_resolved_functions_info(void)
{
  ...
  *c12_identifier)
{
  ...
  c12_y = c12_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_ekffedepre), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_ekffedepre);
  return c12_y;
}
...
/* SFunction Glue Code */
void sf_c12_ekffedepre_get_check_sum(mxArray *plhs[])
{
...
static const mxArray *sf_get_sim_state_info_c12_ekffedepre(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c12_ekffedepre\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c12_ekffedepre_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc12_ekffedepreInstanceStruct *chartInstance;
    chartInstance = (SFc12_ekffedepreInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c12_ekffedepre(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc12_ekffedepreInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c12_ekffedepre((SFc12_ekffedepreInstanceStruct*)
    chartInstanceVar);
  initialize_c12_ekffedepre((SFc12_ekffedepreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c12_ekffedepre(void *chartInstanceVar)
{
  enable_c12_ekffedepre((SFc12_ekffedepreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c12_ekffedepre(void *chartInstanceVar)
{
  disable_c12_ekffedepre((SFc12_ekffedepreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c12_ekffedepre(void *chartInstanceVar)
{
  sf_c12_ekffedepre((SFc12_ekffedepreInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c12_ekffedepre(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c12_ekffedepre
    ((SFc12_ekffedepreInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c12_ekffedepre();/* state var info */
...
extern void sf_internal_set_sim_state_c12_ekffedepre(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c12_ekffedepre((SFc12_ekffedepreInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c12_ekffedepre(SimStruct* S)
{
  return sf_internal_get_sim_state_c12_ekffedepre(S);
}

static void sf_opaque_set_sim_state_c12_ekffedepre(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c12_ekffedepre(S, st);
}

static void sf_opaque_terminate_c12_ekffedepre(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_ekffedepreInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c12_ekffedepre((SFc12_ekffedepreInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc12_ekffedepre((SFc12_ekffedepreInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_ekffedepre(SimStruct *S)
{
  int i;
...
static void mdlRTW_c12_ekffedepre(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "ekffedepre", "ekffedepre",12);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c12_ekffedepre(SimStruct *S)
{
  SFc12_ekffedepreInstanceStruct *chartInstance;
  chartInstance = (SFc12_ekffedepreInstanceStruct *)malloc(sizeof
    (SFc12_ekffedepreInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc12_ekffedepreInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c12_ekffedepre;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c12_ekffedepre;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c12_ekffedepre;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c12_ekffedepre;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c12_ekffedepre;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c12_ekffedepre;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c12_ekffedepre;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_ekffedepre;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_ekffedepre;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_ekffedepre;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c12_ekffedepre;
...
void c12_ekffedepre_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_ekffedepre(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_ekffedepre(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_ekffedepre(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_ekffedepre_method_dispatcher.\n"
