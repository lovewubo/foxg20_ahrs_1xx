...
static void initialize_c21_ekffedepre(SFc21_ekffedepreInstanceStruct
  *chartInstance);
static void initialize_params_c21_ekffedepre(SFc21_ekffedepreInstanceStruct
  *chartInstance);
static void enable_c21_ekffedepre(SFc21_ekffedepreInstanceStruct *chartInstance);
static void disable_c21_ekffedepre(SFc21_ekffedepreInstanceStruct *chartInstance);
static void c21_update_debugger_state_c21_ekffedepre
  (SFc21_ekffedepreInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c21_ekffedepre
  (SFc21_ekffedepreInstanceStruct *chartInstance);
static void set_sim_state_c21_ekffedepre(SFc21_ekffedepreInstanceStruct
  *chartInstance, const mxArray *c21_st);
static void finalize_c21_ekffedepre(SFc21_ekffedepreInstanceStruct
  *chartInstance);
static void sf_c21_ekffedepre(SFc21_ekffedepreInstanceStruct *chartInstance);
static void initSimStructsc21_ekffedepre(SFc21_ekffedepreInstanceStruct
  *chartInstance);
...
static const mxArray *c21_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static real_T c21_emlrt_marshallIn(SFc21_ekffedepreInstanceStruct *chartInstance,
  const mxArray *c21_yaw_dot, const char_T *c21_identifier);
static real_T c21_b_emlrt_marshallIn(SFc21_ekffedepreInstanceStruct
...
static const mxArray *c21_c_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static int32_T c21_c_emlrt_marshallIn(SFc21_ekffedepreInstanceStruct
  *chartInstance, const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static void c21_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c21_mxArrayInData, const char_T *c21_varName, void *c21_outData);
static uint8_T c21_d_emlrt_marshallIn(SFc21_ekffedepreInstanceStruct
  *chartInstance, const mxArray *c21_b_is_active_c21_ekffedepre, const char_T
  *c21_identifier);
static uint8_T c21_e_emlrt_marshallIn(SFc21_ekffedepreInstanceStruct
  *chartInstance, const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static void init_dsm_address_info(SFc21_ekffedepreInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c21_is_active_c21_ekffedepre = 0U;
}
  ...
  (SFc21_ekffedepreInstanceStruct *chartInstance)
{
  ...
  c21_b_hoistedGlobal = chartInstance->c21_is_active_c21_ekffedepre;
  ...
  *chartInstance, const mxArray *c21_st)
{
  ...
  *c21_yaw_dot = c21_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c21_u, 0)), "yaw_dot");
  chartInstance->c21_is_active_c21_ekffedepre = c21_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c21_u, 1)),
     "is_active_c21_ekffedepre");
  sf_mex_destroy(&c21_u);
  c21_update_debugger_state_c21_ekffedepre(chartInstance);
  ...
  *c21_inData)
{
  ...
  const mxArray *c21_y = NULL;
  SFc21_ekffedepreInstanceStruct *chartInstance;
  chartInstance = (SFc21_ekffedepreInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c21_ekffedepre_get_eml_resolved_functions_info(void)
{
  ...
  *c21_identifier)
{
  ...
  c21_y = c21_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c21_b_is_active_c21_ekffedepre), &c21_thisId);
  sf_mex_destroy(&c21_b_is_active_c21_ekffedepre);
  return c21_y;
}
...
/* SFunction Glue Code */
void sf_c21_ekffedepre_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c21_ekffedepre_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c21_ekffedepre(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"yaw_dot\",},{M[8],M[0],T\"is_active_c21_ekffedepre\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c21_ekffedepre_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc21_ekffedepreInstanceStruct *chartInstance;
    chartInstance = (SFc21_ekffedepreInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c21_ekffedepre(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc21_ekffedepreInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c21_ekffedepre((SFc21_ekffedepreInstanceStruct*)
    chartInstanceVar);
  initialize_c21_ekffedepre((SFc21_ekffedepreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c21_ekffedepre(void *chartInstanceVar)
{
  enable_c21_ekffedepre((SFc21_ekffedepreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c21_ekffedepre(void *chartInstanceVar)
{
  disable_c21_ekffedepre((SFc21_ekffedepreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c21_ekffedepre(void *chartInstanceVar)
{
  sf_c21_ekffedepre((SFc21_ekffedepreInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c21_ekffedepre(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c21_ekffedepre
    ((SFc21_ekffedepreInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c21_ekffedepre();/* state var info */
...
extern void sf_internal_set_sim_state_c21_ekffedepre(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c21_ekffedepre((SFc21_ekffedepreInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c21_ekffedepre(SimStruct* S)
{
  return sf_internal_get_sim_state_c21_ekffedepre(S);
}

static void sf_opaque_set_sim_state_c21_ekffedepre(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c21_ekffedepre(S, st);
}

static void sf_opaque_terminate_c21_ekffedepre(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc21_ekffedepreInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c21_ekffedepre((SFc21_ekffedepreInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc21_ekffedepre((SFc21_ekffedepreInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c21_ekffedepre(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c21_ekffedepre(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"ekffedepre","ekffedepre",21);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"ekffedepre","ekffedepre",21,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"ekffedepre",
      "ekffedepre",21,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"ekffedepre","ekffedepre",21,3);
      sf_mark_chart_reusable_outputs(S,"ekffedepre","ekffedepre",21,1);
    }

    sf_set_rtw_dwork_info(S,"ekffedepre","ekffedepre",21);
...
static void mdlRTW_c21_ekffedepre(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "ekffedepre", "ekffedepre",21);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c21_ekffedepre(SimStruct *S)
{
  SFc21_ekffedepreInstanceStruct *chartInstance;
  chartInstance = (SFc21_ekffedepreInstanceStruct *)malloc(sizeof
    (SFc21_ekffedepreInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc21_ekffedepreInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c21_ekffedepre;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c21_ekffedepre;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c21_ekffedepre;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c21_ekffedepre;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c21_ekffedepre;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c21_ekffedepre;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c21_ekffedepre;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c21_ekffedepre;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c21_ekffedepre;
  chartInstance->chartInfo.mdlStart = mdlStart_c21_ekffedepre;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c21_ekffedepre;
...
void c21_ekffedepre_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c21_ekffedepre(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c21_ekffedepre(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c21_ekffedepre(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c21_ekffedepre_method_dispatcher.\n"
