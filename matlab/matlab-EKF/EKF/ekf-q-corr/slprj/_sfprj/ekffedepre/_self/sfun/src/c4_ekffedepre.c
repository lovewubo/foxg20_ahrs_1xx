...
static void initialize_c4_ekffedepre(SFc4_ekffedepreInstanceStruct
  *chartInstance);
static void initialize_params_c4_ekffedepre(SFc4_ekffedepreInstanceStruct
  *chartInstance);
static void enable_c4_ekffedepre(SFc4_ekffedepreInstanceStruct *chartInstance);
static void disable_c4_ekffedepre(SFc4_ekffedepreInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_ekffedepre(SFc4_ekffedepreInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c4_ekffedepre(SFc4_ekffedepreInstanceStruct *
  chartInstance);
static void set_sim_state_c4_ekffedepre(SFc4_ekffedepreInstanceStruct
  *chartInstance, const mxArray *c4_st);
static void finalize_c4_ekffedepre(SFc4_ekffedepreInstanceStruct *chartInstance);
static void sf_c4_ekffedepre(SFc4_ekffedepreInstanceStruct *chartInstance);
static void initSimStructsc4_ekffedepre(SFc4_ekffedepreInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static void c4_emlrt_marshallIn(SFc4_ekffedepreInstanceStruct *chartInstance,
  const mxArray *c4_dotxk, const char_T *c4_identifier, real_T c4_y[7]);
static void c4_b_emlrt_marshallIn(SFc4_ekffedepreInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[7]);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_c_emlrt_marshallIn(SFc4_ekffedepreInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_d_emlrt_marshallIn(SFc4_ekffedepreInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_e_emlrt_marshallIn(SFc4_ekffedepreInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_ekffedepre, const char_T
  *c4_identifier);
static uint8_T c4_f_emlrt_marshallIn(SFc4_ekffedepreInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_ekffedepreInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_ekffedepre = 0U;
}
  ...
  chartInstance)
{
  ...
  c4_hoistedGlobal = chartInstance->c4_is_active_c4_ekffedepre;
  ...
  *chartInstance, const mxArray *c4_st)
{
  ...
  chartInstance->c4_is_active_c4_ekffedepre = c4_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 1)),
     "is_active_c4_ekffedepre");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_ekffedepre(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  real_T c4_u[7];
  const mxArray *c4_y = NULL;
  SFc4_ekffedepreInstanceStruct *chartInstance;
  chartInstance = (SFc4_ekffedepreInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_ekffedepre_get_eml_resolved_functions_info(void)
{
  ...
  *c4_identifier)
{
  ...
  c4_y = c4_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_ekffedepre), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_ekffedepre);
  return c4_y;
}
...
/* SFunction Glue Code */
void sf_c4_ekffedepre_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_ekffedepre_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_ekffedepre(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"dotxk\",},{M[8],M[0],T\"is_active_c4_ekffedepre\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_ekffedepre_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_ekffedepreInstanceStruct *chartInstance;
    chartInstance = (SFc4_ekffedepreInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c4_ekffedepre(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_ekffedepreInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c4_ekffedepre((SFc4_ekffedepreInstanceStruct*)
    chartInstanceVar);
  initialize_c4_ekffedepre((SFc4_ekffedepreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_ekffedepre(void *chartInstanceVar)
{
  enable_c4_ekffedepre((SFc4_ekffedepreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_ekffedepre(void *chartInstanceVar)
{
  disable_c4_ekffedepre((SFc4_ekffedepreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_ekffedepre(void *chartInstanceVar)
{
  sf_c4_ekffedepre((SFc4_ekffedepreInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_ekffedepre(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_ekffedepre
    ((SFc4_ekffedepreInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_ekffedepre();/* state var info */
...
extern void sf_internal_set_sim_state_c4_ekffedepre(SimStruct* S, const mxArray *
  st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c4_ekffedepre((SFc4_ekffedepreInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_ekffedepre(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_ekffedepre(S);
}

static void sf_opaque_set_sim_state_c4_ekffedepre(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c4_ekffedepre(S, st);
}

static void sf_opaque_terminate_c4_ekffedepre(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_ekffedepreInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c4_ekffedepre((SFc4_ekffedepreInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_ekffedepre((SFc4_ekffedepreInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_ekffedepre(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_ekffedepre(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"ekffedepre","ekffedepre",4);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"ekffedepre","ekffedepre",4,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"ekffedepre",
      "ekffedepre",4,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 3, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"ekffedepre","ekffedepre",4,4);
      sf_mark_chart_reusable_outputs(S,"ekffedepre","ekffedepre",4,1);
    }

    sf_set_rtw_dwork_info(S,"ekffedepre","ekffedepre",4);
...
static void mdlRTW_c4_ekffedepre(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "ekffedepre", "ekffedepre",4);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c4_ekffedepre(SimStruct *S)
{
  SFc4_ekffedepreInstanceStruct *chartInstance;
  chartInstance = (SFc4_ekffedepreInstanceStruct *)malloc(sizeof
    (SFc4_ekffedepreInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_ekffedepreInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c4_ekffedepre;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c4_ekffedepre;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c4_ekffedepre;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_ekffedepre;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_ekffedepre;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c4_ekffedepre;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c4_ekffedepre;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c4_ekffedepre;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_ekffedepre;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_ekffedepre;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_ekffedepre;
...
void c4_ekffedepre_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_ekffedepre(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_ekffedepre(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_ekffedepre(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_ekffedepre_method_dispatcher.\n"
