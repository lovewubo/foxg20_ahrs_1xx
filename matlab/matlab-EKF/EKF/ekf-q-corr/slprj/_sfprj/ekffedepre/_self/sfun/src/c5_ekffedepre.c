...
static void initialize_c5_ekffedepre(SFc5_ekffedepreInstanceStruct
  *chartInstance);
static void initialize_params_c5_ekffedepre(SFc5_ekffedepreInstanceStruct
  *chartInstance);
static void enable_c5_ekffedepre(SFc5_ekffedepreInstanceStruct *chartInstance);
static void disable_c5_ekffedepre(SFc5_ekffedepreInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_ekffedepre(SFc5_ekffedepreInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c5_ekffedepre(SFc5_ekffedepreInstanceStruct *
  chartInstance);
static void set_sim_state_c5_ekffedepre(SFc5_ekffedepreInstanceStruct
  *chartInstance, const mxArray *c5_st);
static void finalize_c5_ekffedepre(SFc5_ekffedepreInstanceStruct *chartInstance);
static void sf_c5_ekffedepre(SFc5_ekffedepreInstanceStruct *chartInstance);
static void initSimStructsc5_ekffedepre(SFc5_ekffedepreInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_ekffedepreInstanceStruct *chartInstance,
  const mxArray *c5_wave, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_ekffedepreInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_c_emlrt_marshallIn(SFc5_ekffedepreInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_d_emlrt_marshallIn(SFc5_ekffedepreInstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_ekffedepre, const char_T
  *c5_identifier);
static uint8_T c5_e_emlrt_marshallIn(SFc5_ekffedepreInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_ekffedepreInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_ekffedepre = 0U;
}
  ...
  chartInstance)
{
  ...
  c5_b_hoistedGlobal = chartInstance->c5_is_active_c5_ekffedepre;
  ...
  *chartInstance, const mxArray *c5_st)
{
  ...
  *c5_wave = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u,
    0)), "wave");
  chartInstance->c5_is_active_c5_ekffedepre = c5_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 1)),
     "is_active_c5_ekffedepre");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_ekffedepre(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  real_T c5_u;
  const mxArray *c5_y = NULL;
  SFc5_ekffedepreInstanceStruct *chartInstance;
  chartInstance = (SFc5_ekffedepreInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c5_ekffedepre_get_eml_resolved_functions_info(void)
{
  ...
  *c5_identifier)
{
  ...
  c5_y = c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_ekffedepre), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_ekffedepre);
  return c5_y;
}
...
/* SFunction Glue Code */
void sf_c5_ekffedepre_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_ekffedepre_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_ekffedepre(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"wave\",},{M[8],M[0],T\"is_active_c5_ekffedepre\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_ekffedepre_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc5_ekffedepreInstanceStruct *chartInstance;
    chartInstance = (SFc5_ekffedepreInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c5_ekffedepre(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_ekffedepreInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c5_ekffedepre((SFc5_ekffedepreInstanceStruct*)
    chartInstanceVar);
  initialize_c5_ekffedepre((SFc5_ekffedepreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_ekffedepre(void *chartInstanceVar)
{
  enable_c5_ekffedepre((SFc5_ekffedepreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_ekffedepre(void *chartInstanceVar)
{
  disable_c5_ekffedepre((SFc5_ekffedepreInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_ekffedepre(void *chartInstanceVar)
{
  sf_c5_ekffedepre((SFc5_ekffedepreInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_ekffedepre(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_ekffedepre
    ((SFc5_ekffedepreInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_ekffedepre();/* state var info */
...
extern void sf_internal_set_sim_state_c5_ekffedepre(SimStruct* S, const mxArray *
  st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c5_ekffedepre((SFc5_ekffedepreInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_ekffedepre(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_ekffedepre(S);
}

static void sf_opaque_set_sim_state_c5_ekffedepre(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c5_ekffedepre(S, st);
}

static void sf_opaque_terminate_c5_ekffedepre(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_ekffedepreInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c5_ekffedepre((SFc5_ekffedepreInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_ekffedepre((SFc5_ekffedepreInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_ekffedepre(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_ekffedepre(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"ekffedepre","ekffedepre",5);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"ekffedepre","ekffedepre",5,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"ekffedepre",
      "ekffedepre",5,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"ekffedepre","ekffedepre",5,5);
      sf_mark_chart_reusable_outputs(S,"ekffedepre","ekffedepre",5,1);
    }

    sf_set_rtw_dwork_info(S,"ekffedepre","ekffedepre",5);
...
static void mdlRTW_c5_ekffedepre(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "ekffedepre", "ekffedepre",5);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c5_ekffedepre(SimStruct *S)
{
  SFc5_ekffedepreInstanceStruct *chartInstance;
  chartInstance = (SFc5_ekffedepreInstanceStruct *)malloc(sizeof
    (SFc5_ekffedepreInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_ekffedepreInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_ekffedepre;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_ekffedepre;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_ekffedepre;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_ekffedepre;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_ekffedepre;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_ekffedepre;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_ekffedepre;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c5_ekffedepre;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_ekffedepre;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_ekffedepre;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_ekffedepre;
...
void c5_ekffedepre_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_ekffedepre(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_ekffedepre(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_ekffedepre(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_ekffedepre_method_dispatcher.\n"
