...
MODEL                   = calibrazione_acc
MODULES                 = calibrazione_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE                = calibrazione_acc.mk
...
MASTER_ANCHOR_DIR       = 
START_DIR               = C:\Users\Fede\Desktop\matlab-EKF\calibrazione-accell
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
...
MODELLIB                  = calibrazione_acclib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = calibrazione_acc_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\calibrazione_acc_ert_rtw
